    ...
    <div className={styles.cvresume}>
      ...
      <div className={styles.aboutMe}>
        ...
        <div className={styles.yourContact}>
          <div className={styles.yourMailChild} />
          <div className={styles.div}>@unix_568</div>
          <img className={styles.mdiMailIcon} alt="" src="/mdi--telegram.svg" />
        </div>
      ...
      <div className={styles.educationAndSkill}>
        ...
        <div className={styles.education}>
          ...
          <div className={styles.beInIt}>
            <b className={styles.bachelorOfEngineering}>{`Master in Computer Systems Engineering.`}</b>
          ...
          <div className={styles.njit}>
            ...
            >{`Bachelor in Computer Hardware Engineering.`}</b>
